...
type MONOType = {
   ...
   * @deprecated Please use [JSImportAttribute] or [JSExportAttribute] for interop instead.
   */
  mono_wasm_new_root: <T extends MonoObject>(
    value?: T | undefined,
  ) => WasmRoot<T>;
  /**
   * @deprecated Please use [JSImportAttribute] or [JSExportAttribute] for interop instead.
   */
  mono_wasm_new_external_root: <T extends MonoObject>(
